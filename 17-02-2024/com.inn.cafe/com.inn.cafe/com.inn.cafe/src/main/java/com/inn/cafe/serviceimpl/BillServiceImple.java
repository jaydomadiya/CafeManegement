    ...
    public ResponseEntity<String> generateReport(Map<String, Object> requestMap) {
        ...
        try {
            ...
            if (validateRequestMap(requestMap)) {
                ...
                PdfWriter.getInstance(document,new FileOutputStream(CafeContstants.STORE_LOCATION+"\\"+fileName+".pdf"));
                document.open();
            ...
            return CafeUtil.getResponseEntity("somthing went wrong..", HttpStatus.BAD_REQUEST);
        } catch (Exception ex) {
            ex.printStackTrace();
        }
